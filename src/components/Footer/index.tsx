    ...
    <footer className="text-white bg-gray-900 lg:grid lg:grid-cols-5">
      <aside className="hidden lg:relative lg:col-span-2 lg:block">
        <img
          ...
          src="https://images.unsplash.com/photo-1577553694554-3ad4376d2e21?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=934&q=80"
          alt="Comic Graphic"
        />
      </aside>
            ...
            <div className="mapouter">
              <div className="gmap_canvas">
                <iframe
                  ...
                  height="360"
                  id="gmap_canvas"
                  src="https://maps.google.com/maps?q=joyful%20laundry%20bandengan&t=&z=18&ie=UTF8&iwloc=&output=embed"
                  frameBorder="0"
                  scrolling="no"
                  marginHeight={0}
                  marginWidth={0}
